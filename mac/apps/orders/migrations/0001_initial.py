    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_cached', models.TextField(choices=[('moscow', 'Москва'), ('spb', 'Санкт Петербург')], default=('moscow', 'Москва'), verbose_name='Город')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('type', models.TextField(choices=[('comment', 'Комментарий'), ('is_produced', 'Партия произведена'), ('is_delivered', 'Партия доставлена')], default='comment', verbose_name='Тип обновления')),
                ('comment', models.TextField(verbose_name='Комментарий')),
